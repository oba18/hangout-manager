...
ActiveRecord::Schema.define(version: 2020_08_15_162431) do
  ...
  create_table "recommend_users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_recommend_users_on_user_id"
  end
  ...
  add_foreign_key "recommend_users", "users"
